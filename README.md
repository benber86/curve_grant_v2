...
We apply for a **$800,000 grant** to expend and fund for **two years** the analytics team that works on the curvemonitor platform, infrastructure for curve.fi's backend, platform monitoring bots on social media and produces ad-hoc reports on topics ranging from MEV to crvUSD borrower behavior.
...
The total costs are **$775,200 for payroll** for the four developers and **$24,800 for infrastructure expenses** and overhead, adding up to a **total of $800,000**. Unused funds will be returned to the DAO at the end of the grant period.

The team will be working on the following tasks:

### Expansion and improvement of Curve Monitor
- Improve the range and accuracy of analytics currently offered on the platform: Impermanent loss calculator/simulator, MEV analysis, DAO stats, chain-specific dashboards
...
|----------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------|----------------------------------------------------------------------------|
| Alunara        | Front-end development, DevOps                                                                                                                                                | Full time                                                    | $212,000 for 2 years ($104k first year, $108k 2nd year)                    |
| benny          | Back-end development (`curve-prices` and analytics API), subgraphs, ad-hoc analytics reports, management and liaison with other teams within the DAO & integrating protocols | Part-time (80%) for the first year, full time for the second | $191,200 for 2 years ($83,200 1st year, $108k 2nd year)                    |
| Philipp        | Back-end development, MEV analytics, ad-hoc analytics reports, telegram bots                                                                                                 | Full time                                                    | $212,000 for 2 years ($104k first year, $108k 2nd year)                    |
| New hire (TBD) | Back-end development (analytics API), ad-hoc analytics reports                                                                                                               | Full time                                                    | $160,000 for 2 years ($52k after recruitment mid-1st year, $108k 2nd year) |


### Infrastructure & operational costs

Total projected cost of **$14,616 for 2 years**, unused funds will be returned to the DAO at the end of the grant period.

**Cloud computing (AWS) Costs:**

_Total: $2,750 for 2 years_
...
| Pinata          | IPFS gateway and pinning services, used for DAO proposals and for planned addition to vyper/Ape of a plugin to upload contract source code to IPFS to avoid over reliance on block explorer code verification                     | $20/m or $480 for 2 years   |
...
| Tenderly        | Advance transaction debugging and simulations                                                                                                                                                                                     | $67/m or $1608 for 2 years  |



**Additional services and operational costs:**

_Total: $1,720 for 2 years_
...
| Gas tokens     | Used to pay for transactions on Ethereum mainnet and other chains | $1000 for 2 years         |



## Payment 

We ask for a payment of $800,000 streamed over 2 years with the possibility of clawback at any time by the DAO.
